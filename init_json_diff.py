...
# 1) init_json_diff.py <первый файл.JSON> <второй файл.json> -- разобрать JSON на структуру из папок и файлов (поля
# JSON) -- в папках где есть 1.json и 2.json создать файл различий через diff -u 1.json 2.json
